...
| Pillow and compiled image/text libraries | Pillow 12.2.0; the official Windows wheel reports FreeType 2.14.3, LittleCMS2 2.18, WebP 1.6.0, AVIF 1.4.1, libraqm 0.10.3, FriBidi 1.0.12, HarfBuzz 13.2.1, libjpeg-turbo 3.1.4.1, zlib-ng 2.3.3 / zlib 1.3.1, OpenJPEG 2.5.4, and libtiff 4.7.1 | MIT-CMU plus the FTL, LGPL-2.1-or-later, MIT, BSD, IJG, zlib, libtiff, and other terms reproduced by Pillow | `LICENSES/Pillow-12.2.0.txt`, `LICENSES/LGPL-2.1.txt` |
...
| wheel | 0.45.1, hash-locked build environment only | MIT; used to build the pinned APKUtils2 source distribution and not shipped in the application | `LICENSES/wheel-0.45.1.txt` |
...
| setuptools | 81.0.0, build environment only | MIT | `LICENSES/setuptools-81.0.0.txt` |
